...
class EventBasedTaskCondition(object):
    ...
    def field(self):
        ...
        The event field to match against when evaluating this condition. Use `tag` enum to specify \"Cloud Instance Metadata\" which correspond to \"AWS Tags\", \"Azure Tags\" or \"GCP Labels\".  # noqa: E501
