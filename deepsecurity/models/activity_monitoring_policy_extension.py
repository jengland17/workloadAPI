...
class ActivityMonitoringPolicyExtension(object):
    ...
    def __init__(self, state=None, module_status=None):  # noqa: E501
        """ActivityMonitoringPolicyExtension - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def state(self):
        """Gets the state of this ActivityMonitoringPolicyExtension.  # noqa: E501

        Module state. The 'inherited' value is write-only.  # noqa: E501

        :return: The state of this ActivityMonitoringPolicyExtension.  # noqa: E501
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """Sets the state of this ActivityMonitoringPolicyExtension.

        Module state. The 'inherited' value is write-only.  # noqa: E501

        :param state: The state of this ActivityMonitoringPolicyExtension.  # noqa: E501
        :type: str
        """
    ...
    def module_status(self):
        """Gets the module_status of this ActivityMonitoringPolicyExtension.  # noqa: E501


        :return: The module_status of this ActivityMonitoringPolicyExtension.  # noqa: E501
    ...
    def module_status(self, module_status):
        """Sets the module_status of this ActivityMonitoringPolicyExtension.


        :param module_status: The module_status of this ActivityMonitoringPolicyExtension.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ActivityMonitoringPolicyExtension, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ActivityMonitoringPolicyExtension):
            return False
